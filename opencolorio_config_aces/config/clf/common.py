...
"""
Common LUT Format Generation Common Objects
===========================================

Defines various objects related to *Common LUT Format* (CLF) generation:
...
def generate_clf(clf_name, transforms, **kwargs):
    ...
    group_transform.write('Academy/ASC Common LUT Format', clf_name,
                          raw_config)
...
if __name__ == '__main__':
    ...
    generate_clf(
        build_directory + '/Utility_sRGB_Linear.clf', [matrix_transform],
        ID='Utility-sRGB-Linear',
        name='Utility - sRGB - Linear',
        description='Matrix converting from sRGB to ACES2065-1 colourspace.')
