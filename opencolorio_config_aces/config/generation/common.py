...
class ConfigData:
    ...
    colorspaces: list = field(default_factory=list)
    named_transforms: list = field(default_factory=list)
    view_transforms: list = field(default_factory=list)
    looks: list = field(default_factory=list)
    shared_views: list = field(default_factory=list)
    views: list = field(default_factory=list)
    active_displays: list = field(default_factory=list)
    active_views: list = field(default_factory=list)
    file_rules: list = field(default_factory=list)
    viewing_rules: list = field(default_factory=list)
    inactive_colorspaces: list = field(default_factory=list)
