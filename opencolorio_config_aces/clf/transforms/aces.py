...
def generate_clf_aces(directory):
    ...
    _dummy_metadata["ID"] = (
        "urn:aswf:ocio:transformId:v1.0:" "ACES.OCIO.AP0_to_Rec709-sRGB.c1.v1"
    )
    ...
    _dummy_metadata["ID"] = (
        "urn:aswf:ocio:transformId:v1.0:" "ACES.OCIO.Rec709-sRGB_to_AP0.c1.v1"
    )
    generate_clf(clf_path, [_dummy_matrix_transform], **_dummy_metadata)
    clf_transforms.append(clf_path)
    ...
    _dummy_metadata["ID"] = (
        "urn:aswf:ocio:transformId:v1.0:"
